...
export default function Navigation() {
    return (
        <div className='min-h-screen flex bg-purple-300 m-0 sticky top-0 pl-5 pt-3'>
            <h1 className='inline-flex font-cubano text-pink-200 pr-14 m-0 align-middle text-5xl w-full md:w-auto'>MOVIE CHOOSER</h1>
            <div className='bg-purple-300 pl-14 ml-14 top-0 w-screen md:w-full'>
                <nav className='bg-pink-200 align-middle w-screen md:w-auto'>
